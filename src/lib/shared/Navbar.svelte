...
<nav
	class="fixed inset-x-0 top-8 z-10 mx-auto flex w-fit scale-80 sm:scale-90 items-center justify-center space-x-2 rounded-full bg-white/50 p-2 shadow-md/5 backdrop-blur-md md:scale-100"
>
	<a
		href="/"
